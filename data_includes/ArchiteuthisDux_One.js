...
[["MODALITYNEGATION-notnecessary",5], "Question", {q:"In ‘Tom must not eat the bread. It won't go stale by tomorrow.’, ‘Tom must not eat the bread.’ means",as: [['s','It is necessary that Tom does not the bread.'],['k','It is not necessary that Tom eats the bread.']]},
...
[["MODALITYNEGATION-necessarynot",5], "Question", {q:"In ‘Tom must not eat the bread. They have visitors coming over.’, ‘Tom must not eat the bread.’ means",as: [['s','It is necessary that Tom does not the bread.'],['k','It is not necessary that Tom eats the bread.']]},
...
[["filler-need", 21], "Question", {q:"In ‘Bill need not be excited. The woman invited him to his favorite film.’, ‘Bill need not be excited.’ means",as: [['s','It is not necessary that Bill is excited.'],['k','It is not necessary that Bill is excited.']]},
...
[["filler-need",22], "Question", {q:"In  ‘You need not be pleased. Your husband gave you a wonderful gift.’, ‘You need not be pleased. ’ means",as: [['s','It is not necessary that you are pleased.'],['k','It is not necessary that you are pleased.']]},
...
[["filler-need",23], "Question", {q:"In ‘Sarah need not take care of the sick. They are in great suffering.’, ‘Sarah need not take care of the sick.’ means",as: [['s','It is not necessary that Sarah takes care of the sick.'],['k','It is not necessary that Sarah takes care of the sick.']]},
...
[["filler-need",24], "Question", {q:"In ‘You need not sweep the floor. It is very dirty.’, ‘You need not sweep the floor.’ means",as: [['s','It is not necessary that you sweep the floor.'],['k','It is not necessary that you sweep the floor.']]},
